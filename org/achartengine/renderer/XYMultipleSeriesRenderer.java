...
public class XYMultipleSeriesRenderer extends DefaultRenderer {
    ...
    public void initAxesRange(int scales) {
        ...
        for (int i = 0; i < scales; i++) {
            ...
            this.mGridColors[i] = Color.argb(75, AsyncTaskManager.REQUEST_SUCCESS_CODE, AsyncTaskManager.REQUEST_SUCCESS_CODE, AsyncTaskManager.REQUEST_SUCCESS_CODE);
    ...
    public void initAxesRangeForScale(int i) {
        ...
        this.mYTitle[i] = XmlPullParser.NO_NAMESPACE;
