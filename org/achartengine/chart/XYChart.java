...
public abstract class XYChart extends AbstractChart {
    ...
    public void draw(Canvas canvas, int x, int y, int width, int height, Paint paint) {
        ...
        if (maxScaleNumber >= 0) {
                ...
                if (series.getItemCount() != 0) {
                    ...
                    synchronized (series) {
                        ...
                        for (Entry<Double, Double> value : series.getRange(minX[scale], maxX[scale], seriesRenderer.isDisplayBoundingPoints()).entrySet()) {
                            ...
                            values.add((Double) value.getKey());
            ...
            if (showLabels || showGridX) {
                ...
                if (showLabels) {
                    ...
                    while (i < maxScaleNumber) {
                        axisAlign = this.mRenderer.getYAxisAlign(i);
                            ...
                            if (minY[i] <= location.doubleValue() && location.doubleValue() <= maxY[i]) {
                                ...
                                if (or == Orientation.HORIZONTAL) {
                                    if (axisAlign == Align.LEFT) {
                                        if (showTickMarks) {
                                            if (this.mRenderer.getGraphType() == 1) {
                                                if (i % 2 == 0) {
                                                    canvas.drawLine((float) left, yLabel, (float) (left + 10), yLabel, paint);
                                                    drawText(canvas, label, (float) (left + 15), yLabel - this.mRenderer.getYLabelsVerticalPadding(), paint, this.mRenderer.getYLabelsAngle());
                                                    if (!label.equals(XmlPullParser.NO_NAMESPACE)) {
                                            ...
                                            } else if (this.mRenderer.getGraphType() == 0) {
                                                canvas.drawLine((float) left, yLabel, (float) (getLabelLinePos(axisAlign) + left), yLabel, paint);
                                        ...
                                        if (this.mRenderer.getGraphType() == 1) {
                                            if (i % 2 != 0) {
                                                canvas.drawLine((float) ((getLabelLinePos(axisAlign) + right) - 5), yLabel, (float) (right - 10), yLabel, paint);
                                                drawText(canvas, label, (float) (right - 15), yLabel - this.mRenderer.getYLabelsVerticalPadding(), paint, this.mRenderer.getYLabelsAngle());
                                            } else {
                                                canvas.drawLine((float) right, yLabel, (float) ((getLabelLinePos(axisAlign) + right) + 5), yLabel, paint);
                                                drawText(canvas, label, (float) (right + 15), yLabel - this.mRenderer.getYLabelsVerticalPadding(), paint, this.mRenderer.getYLabelsAngle());
                                            }
                                        } else if (this.mRenderer.getGraphType() == 0) {
                                            canvas.drawLine((float) (getLabelLinePos(axisAlign) + right), yLabel, (float) right, yLabel, paint);
                                    ...
                                    if (showTickMarks) {
                                        if (this.mRenderer.getGraphType() == 1) {
                                            if (i % 2 != 0) {
                                                ...
                                                canvas.drawLine((float) ((getLabelLinePos(axisAlign) + right) - 5), yLabel, (float) (right - 5), yLabel, paint);
                                            }
                                        } else if (this.mRenderer.getGraphType() == 0) {
                                            canvas.drawLine((float) right, yLabel, (float) (right - getLabelLinePos(axisAlign)), yLabel, paint);
                                        }
                                    }
                                    if (showCustomTextGridY) {
                                        paint.setColor(this.mRenderer.getGridColor(i));
                    ...
                    if (or == Orientation.HORIZONTAL) {
                        ...
                        for (i = 0; i < maxScaleNumber; i++) {
                            ...
                            if (axisAlign == Align.LEFT) {
                                ...
                                if (this.mRenderer.getGraphType() == 1) {
                                    if (i % 2 == 0) {
                                        drawText(canvas, this.mRenderer.getYTitle(i), ((((float) x) + size) + ((float) 15)) + 83.0f, 35.0f, paint, -90.0f);
                                    } else {
                                        drawText(canvas, this.mRenderer.getYTitle(i), ((((float) x) + size) + ((float) 15)) + 20.0f, 35.0f, paint, -90.0f);
                                    }
                                } else if (this.mRenderer.getGraphType() == 0) {
                                    drawText(canvas, this.mRenderer.getYTitle(i), ((float) x) + size, (float) ((height / 2) + y), paint, -90.0f);
                                }
                            } else if (this.mRenderer.getGraphType() == 1) {
                                if (i % 2 == 1) {
                                    drawText(canvas, this.mRenderer.getYTitle(i), (float) (((x + width) - 15) - 83), 35.0f, paint, -90.0f);
                                } else {
                                    drawText(canvas, this.mRenderer.getYTitle(i), (float) (((x + width) - 15) - 20), 35.0f, paint, -90.0f);
                                }
                            } else if (this.mRenderer.getGraphType() == 0) {
            ...
            if (or == Orientation.HORIZONTAL) {
                drawLegend(canvas, this.mRenderer, titles, left, right, (((int) this.mRenderer.getXLabelsPadding()) + y) + 5, width, height, legendSize, paint, false);
            } else if (or == Orientation.VERTICAL) {
                transform(canvas, (float) angle, true);
                drawLegend(canvas, this.mRenderer, titles, left, right, (((int) this.mRenderer.getXLabelsPadding()) + y) + 25, width, height, legendSize, paint, false);
                transform(canvas, (float) angle, false);
            }
                        ...
                        if (axisAlign == Align.LEFT) {
                            if (showTickMarks) {
                                if (i % 2 == 0) {
                                    ...
                                    canvas.drawLine((float) (left + 5), yLabel, (float) ((getLabelLinePos(axisAlign) + left) + 5), yLabel, paint);
                                }
                            }
                            if (i % 2 == 0) {
                                ...
                                drawText(canvas, getLabel(this.mRenderer.getLabelFormat(), label), (((float) left) - this.mRenderer.getYLabelsPadding()) + 10.0f, yLabel - this.mRenderer.getYLabelsVerticalPadding(), paint, this.mRenderer.getYLabelsAngle());
                            }
                        } else {
                            if (showTickMarks) {
                                if (i % 2 != 0) {
                            ...
                            if (i % 2 != 0) {
                                drawText(canvas, getLabel(this.mRenderer.getLabelFormat(), label), (((float) right) + this.mRenderer.getYLabelsPadding()) - 18.0f, yLabel - this.mRenderer.getYLabelsVerticalPadding(), paint, this.mRenderer.getYLabelsAngle());
                            } else {
                                drawText(canvas, getLabel(this.mRenderer.getLabelFormat(), label), (((float) right) + this.mRenderer.getYLabelsPadding()) + 15.0f, yLabel - this.mRenderer.getYLabelsVerticalPadding(), paint, this.mRenderer.getYLabelsAngle());
                            }
                        }
                    }
                    if (showGridX) {
