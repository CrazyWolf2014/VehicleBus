...
public class MessageEventManager {
    ...
    /* renamed from: org.jivesoftware.smackx.MessageEventManager.1 */
    class C11691 implements PacketListener {
        C11691() {
        }
    ...
    public MessageEventManager(Connection connection) {
        this.messageEventNotificationListeners = new ArrayList();
        this.messageEventRequestListeners = new ArrayList();
        this.packetFilter = new PacketExtensionFilter(GroupChatInvitation.ELEMENT_NAME, "jabber:x:event");
        this.con = connection;
        init();
    }
    ...
    private void init() {
        this.packetListener = new C11691();
