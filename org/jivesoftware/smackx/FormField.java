...
public class FormField {
    ...
    public static class Option {
        ...
        public boolean equals(Object obj) {
            ...
            if ((this.label == null ? XmlPullParser.NO_NAMESPACE : this.label).equals(option.label == null ? XmlPullParser.NO_NAMESPACE : option.label)) {
                return true;
            }
            return false;
        }
    ...
    public boolean equals(Object obj) {
        ...
        if (toXML().equals(((FormField) obj).toXML())) {
            return true;
        }
        return false;
    }
