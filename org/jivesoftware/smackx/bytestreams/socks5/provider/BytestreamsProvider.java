...
public class BytestreamsProvider implements IQProvider {
    public IQ parseIQ(XmlPullParser xmlPullParser) throws Exception {
        ...
        String attributeValue2 = xmlPullParser.getAttributeValue(XmlPullParser.NO_NAMESPACE, "mode");
        String str = null;
        String str2 = null;
        Object obj = null;
        String str3 = null;
        while (obj == null) {
            ...
            if (next == 2) {
                if (name.equals(StreamHost.ELEMENTNAME)) {
                    ...
                    str3 = xmlPullParser.getAttributeValue(XmlPullParser.NO_NAMESPACE, "port");
                } else if (name.equals(StreamHostUsed.ELEMENTNAME)) {
                    bytestream.setUsedHost(xmlPullParser.getAttributeValue(XmlPullParser.NO_NAMESPACE, "jid"));
                } else if (name.equals(Activate.ELEMENTNAME)) {
                    bytestream.setToActivate(xmlPullParser.getAttributeValue(XmlPullParser.NO_NAMESPACE, "jid"));
                }
            } else if (next == 3) {
