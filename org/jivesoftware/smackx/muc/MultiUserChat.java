...
public class MultiUserChat {
    ...
    static class C12001 implements ConnectionCreationListener {

        /* renamed from: org.jivesoftware.smackx.muc.MultiUserChat.1.1 */
        class C11991 implements NodeInformationProvider {
            final /* synthetic */ Connection val$connection;

            C11991(Connection connection) {
                this.val$connection = connection;
            }

            public List<Item> getNodeItems() {
                List<Item> arrayList = new ArrayList();
                Iterator access$000 = MultiUserChat.getJoinedRooms(this.val$connection);
        ...
        public void connectionCreated(Connection connection) {
            ...
            ServiceDiscoveryManager.getInstanceFor(connection).setNodeInformationProvider(MultiUserChat.discoNode, new C11991(connection));
        }
    }

    /* renamed from: org.jivesoftware.smackx.muc.MultiUserChat.2 */
    class C12012 implements PacketFilter {
    ...
    class C12023 implements PacketFilter {
        C12023() {
        }
    ...
    class C12034 implements PacketListener {
        C12034() {
        }
    ...
    class C12045 implements PacketListener {
        C12045() {
        }
        ...
        public void processPacket(Packet packet) {
            ...
            String str = MultiUserChat.this.room + FilePathGenerator.ANDROID_DIR_SEP + MultiUserChat.this.nickname;
    ...
    class C12056 implements PacketListener {
        C12056() {
        }
    ...
    private static class InvitationsMonitor implements ConnectionListener {
        private static final Map<Connection, WeakReference<InvitationsMonitor>> monitors;
        private Connection connection;
        ...
        class C12061 implements PacketListener {
            C12061() {
            }
        ...
        private void init() {
            ...
            this.invitationPacketListener = new C12061();
    ...
    static {
        ...
        Connection.addConnectionCreationListener(new C12001());
    }
    ...
    public synchronized void create(String str) throws XMPPException {
        if (str != null) {
            if (!str.equals(XmlPullParser.NO_NAMESPACE)) {
                ...
                presence.setTo(this.room + FilePathGenerator.ANDROID_DIR_SEP + str);
                ...
                PacketCollector createPacketCollector = this.connection.createPacketCollector(new AndFilter(new FromMatchesFilter(this.room + FilePathGenerator.ANDROID_DIR_SEP + str), new PacketTypeFilter(Presence.class)));
    ...
    public synchronized void join(String str, String str2, DiscussionHistory discussionHistory, long j) throws XMPPException {
        if (str != null) {
            if (!str.equals(XmlPullParser.NO_NAMESPACE)) {
                ...
                try {
                    packetCollector = this.connection.createPacketCollector(new AndFilter(new FromMatchesFilter(this.room + FilePathGenerator.ANDROID_DIR_SEP + str), new PacketTypeFilter(Presence.class)));
                    this.connection.sendPacket(presence);
    ...
    public synchronized void leave() {
        if (this.joined) {
            ...
            presence.setTo(this.room + FilePathGenerator.ANDROID_DIR_SEP + this.nickname);
            for (PacketInterceptor interceptPacket : this.presenceInterceptors) {
                interceptPacket.interceptPacket(presence);
            }
            this.connection.sendPacket(presence);
    ...
    public void changeAvailabilityStatus(String str, Mode mode) {
        if (this.nickname == null || this.nickname.equals(XmlPullParser.NO_NAMESPACE)) {
            throw new IllegalArgumentException("Nickname must not be null or blank.");
        } else if (this.joined) {
            Packet presence = new Presence(Type.available);
    ...
    public void sendMessage(String str) throws XMPPException {
        Packet message = new Message(this.room, Message.Type.groupchat);
        message.setBody(str);
        this.connection.sendPacket(message);
    }
    ...
    public void changeSubject(String str) throws XMPPException {
        ...
        PacketCollector createPacketCollector = this.connection.createPacketCollector(new AndFilter(new AndFilter(packetFilterArr), new C12012(str)));
        this.connection.sendPacket(message);
    ...
    private void init() {
        ...
        this.messageFilter = new AndFilter(this.messageFilter, new C12023());
        ...
        PacketListener c12034 = new C12034();
        PacketMultiplexListener packetMultiplexListener = new PacketMultiplexListener(this.messageCollector, new C12045(), c12034, new C12056());
