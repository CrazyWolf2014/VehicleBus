        ...
        while (obj == null) {
            ...
            if (next != 2) {
                ...
                if (xmlPullParser.getName().equals("items")) {
                    PacketExtensionProvider packetExtensionProvider = (PacketExtensionProvider) this.nodeParsers.get(xmlPullParser.getAttributeValue(XmlPullParser.NO_NAMESPACE, "node"));
