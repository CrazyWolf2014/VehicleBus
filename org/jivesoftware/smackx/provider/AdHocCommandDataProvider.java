...
public class AdHocCommandDataProvider implements IQProvider {
    ...
    public IQ parseIQ(XmlPullParser xmlPullParser) throws Exception {
        ...
        adHocCommandData.setSessionID(xmlPullParser.getAttributeValue(XmlPullParser.NO_NAMESPACE, "sessionid"));
        adHocCommandData.setNode(xmlPullParser.getAttributeValue(XmlPullParser.NO_NAMESPACE, "node"));
        String attributeValue2 = xmlPullParser.getAttributeValue(XmlPullParser.NO_NAMESPACE, LocationManagerProxy.KEY_STATUS_CHANGED);
        ...
        attributeValue2 = xmlPullParser.getAttributeValue(XmlPullParser.NO_NAMESPACE, Constant.ACTION);
                ...
                while (obj == null) {
                    ...
                    if (next != 2) {
                        if (xmlPullParser.getName().equals("actions")) {
                            attributeValue = xmlPullParser.getAttributeValue(XmlPullParser.NO_NAMESPACE, "execute");
                            ...
                            adHocCommandData.addNote(new AdHocCommandNote(Type.valueOf(xmlPullParser.getAttributeValue(XmlPullParser.NO_NAMESPACE, SharedPref.TYPE)), xmlPullParser.nextText()));
        ...
        while (obj == null) {
            ...
            if (next != 2) {
                ...
                if (!name.equals(GroupChatInvitation.ELEMENT_NAME)) {
                }
