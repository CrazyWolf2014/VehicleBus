...
public class MUCOwnerProvider implements IQProvider {
    ...
    private Item parseItem(XmlPullParser xmlPullParser) throws Exception {
        Object obj = null;
        Item item = new Item(xmlPullParser.getAttributeValue(XmlPullParser.NO_NAMESPACE, "affiliation"));
        item.setNick(xmlPullParser.getAttributeValue(XmlPullParser.NO_NAMESPACE, Nick.ELEMENT_NAME));
        item.setRole(xmlPullParser.getAttributeValue(XmlPullParser.NO_NAMESPACE, "role"));
