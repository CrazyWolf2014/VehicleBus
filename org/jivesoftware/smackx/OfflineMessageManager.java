...
public class OfflineMessageManager {
    ...
    /* renamed from: org.jivesoftware.smackx.OfflineMessageManager.1 */
    class C11701 implements PacketFilter {
        ...
        public boolean accept(Packet packet) {
            return this.val$nodes.contains(((OfflineMessageInfo) packet.getExtension(MessageEvent.OFFLINE, OfflineMessageManager.namespace)).getNode());
        }
    }

    public OfflineMessageManager(Connection connection) {
        this.connection = connection;
        this.packetFilter = new AndFilter(new PacketExtensionFilter(MessageEvent.OFFLINE, namespace), new PacketTypeFilter(Message.class));
    }
    ...
    public Iterator<OfflineMessageHeader> getHeaders() throws XMPPException {
        ...
        while (items.hasNext()) {
            arrayList.add(new OfflineMessageHeader((Item) items.next()));
        }
    ...
    public Iterator<Message> getMessages(List<String> list) throws XMPPException {
        ...
        PacketCollector createPacketCollector2 = this.connection.createPacketCollector(new AndFilter(this.packetFilter, new C11701(list)));
