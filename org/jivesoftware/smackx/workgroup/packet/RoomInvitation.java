...
public class RoomInvitation implements PacketExtension {
    ...
    public static class Provider implements PacketExtensionProvider {
        public PacketExtension parseExtension(XmlPullParser xmlPullParser) throws Exception {
            PacketExtension roomInvitation = new RoomInvitation();
            roomInvitation.type = Type.valueOf(xmlPullParser.getAttributeValue(XmlPullParser.NO_NAMESPACE, SharedPref.TYPE));
            Object obj = null;
            while (obj == null) {
                xmlPullParser.next();
                ...
                if (xmlPullParser.getEventType() == 2) {
                    if (SessionID.ELEMENT_NAME.equals(name)) {
                        roomInvitation.sessionID = xmlPullParser.getAttributeValue(XmlPullParser.NO_NAMESPACE, LocaleUtil.INDONESIAN);
