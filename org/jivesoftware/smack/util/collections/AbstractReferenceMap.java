...
public abstract class AbstractReferenceMap<K, V> extends AbstractHashedMap<K, V> {
    ...
    static class ReferenceIteratorBase<K, V> {
        ...
        public ReferenceIteratorBase(AbstractReferenceMap<K, V> abstractReferenceMap) {
            ...
            this.index = abstractReferenceMap.size() != 0 ? abstractReferenceMap.data.length : AbstractReferenceMap.HARD;
    ...
    static class ReferenceEntrySet<K, V> extends EntrySet<K, V> {
        ...
        public Object[] toArray() {
            return toArray(new Object[AbstractReferenceMap.HARD]);
        }
    ...
    protected static class ReferenceEntry<K, V> extends HashEntry<K, V> {
        ...
        public boolean equals(Object obj) {
            ...
            if (this.parent.isEqualKey(key, getKey()) && this.parent.isEqualValue(value, getValue())) {
                return true;
            }
            return false;
        }
        ...
        boolean purge(Reference reference) {
            boolean z = false;
            boolean z2 = (this.parent.keyType <= 0 || this.refKey != reference) ? false : AbstractReferenceMap.SOFT;
    ...
    protected int hashEntry(Object obj, Object obj2) {
        int i = HARD;
        int hashCode = obj == null ? HARD : obj.hashCode();
        if (obj2 != null) {
            i = obj2.hashCode();
        }
        return i ^ hashCode;
