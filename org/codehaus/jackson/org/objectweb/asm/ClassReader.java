...
public class ClassReader {
    ...
    public ClassReader(byte[] bArr, int i, int i2) {
        this.f1678b = bArr;
        this.f1677a = new int[readUnsignedShort(i + EXPAND_FRAMES)];
        int length = this.f1677a.length;
        this.f1679c = new String[length];
        int i3 = 0;
        int i4 = i + 10;
        int i5 = SKIP_CODE;
        int i6 = i4;
        while (i5 < length) {
            this.f1677a[i5] = i6 + SKIP_CODE;
            switch (bArr[i6]) {
                case SKIP_CODE /*1*/:
    ...
    private int m1718a(int i, char[] cArr, String str, AnnotationVisitor annotationVisitor) {
        int i2 = false;
        if (annotationVisitor == null) {
            switch (this.f1678b[i] & KEYRecord.PROTOCOL_ANY) {
                case WbxmlParser.WAP_EXTENSION /*64*/:
                    return m1719a(i + 3, cArr, true, null);
                case Service.MIT_DOV /*91*/:
                    return m1719a(i + SKIP_CODE, cArr, false, null);
        ...
        switch (this.f1678b[i] & KEYRecord.PROTOCOL_ANY) {
            case WbxmlParser.WAP_EXTENSION /*64*/:
                return m1719a(i3 + SKIP_DEBUG, cArr, true, annotationVisitor.visitAnnotation(str, readUTF8(i3, cArr)));
            case Protocol.RVD /*66*/:
                annotationVisitor.visit(str, new Byte((byte) readInt(this.f1677a[readUnsignedShort(i3)])));
                return i3 + SKIP_DEBUG;
            case Service.BOOTPS /*67*/:
                annotationVisitor.visit(str, new Character((char) readInt(this.f1677a[readUnsignedShort(i3)])));
                return i3 + SKIP_DEBUG;
            ...
            case Opcodes.AASTORE /*83*/:
                annotationVisitor.visit(str, new Short((short) readInt(this.f1677a[readUnsignedShort(i3)])));
                return i3 + SKIP_DEBUG;
            case Opcodes.DUP_X1 /*90*/:
                annotationVisitor.visit(str, readInt(this.f1677a[readUnsignedShort(i3)]) == 0 ? Boolean.FALSE : Boolean.TRUE);
                return i3 + SKIP_DEBUG;
            case Service.MIT_DOV /*91*/:
                int readUnsignedShort = readUnsignedShort(i3);
                i3 += SKIP_DEBUG;
                if (readUnsignedShort == 0) {
                    return m1719a(i3 - 2, cArr, false, annotationVisitor.visitArray(str));
                }
                int i4 = i3 + SKIP_CODE;
                Object obj;
                switch (this.f1678b[i3] & KEYRecord.PROTOCOL_ANY) {
                    case Protocol.RVD /*66*/:
                        obj = new byte[readUnsignedShort];
                        while (i2 < readUnsignedShort) {
                            obj[i2] = (byte) readInt(this.f1677a[readUnsignedShort(i4)]);
                            i4 += 3;
                            i2 += SKIP_CODE;
                        }
                    ...
                    case Service.BOOTPS /*67*/:
                        ...
                        while (i2 < readUnsignedShort) {
                            obj[i2] = (char) readInt(this.f1677a[readUnsignedShort(i4)]);
                            i4 += 3;
                            i2 += SKIP_CODE;
                        }
                        annotationVisitor.visit(str, obj);
                    ...
                    case Service.BOOTPC /*68*/:
                        ...
                        while (i2 < readUnsignedShort) {
                            obj[i2] = Double.longBitsToDouble(readLong(this.f1677a[readUnsignedShort(i4)]));
                            i4 += 3;
                            i2 += SKIP_CODE;
                        }
                        annotationVisitor.visit(str, obj);
                    ...
                    case 70:
                        ...
                        while (i2 < readUnsignedShort) {
                            obj[i2] = Float.intBitsToFloat(readInt(this.f1677a[readUnsignedShort(i4)]));
                            i4 += 3;
                            i2 += SKIP_CODE;
                        }
                        annotationVisitor.visit(str, obj);
                    ...
                    case Service.NETRJS_3 /*73*/:
                        ...
                        while (i2 < readUnsignedShort) {
                            obj[i2] = readInt(this.f1677a[readUnsignedShort(i4)]);
                            i4 += 3;
                            i2 += SKIP_CODE;
                        }
                        annotationVisitor.visit(str, obj);
                    ...
                    case Service.NETRJS_4 /*74*/:
                        ...
                        while (i2 < readUnsignedShort) {
                            obj[i2] = readLong(this.f1677a[readUnsignedShort(i4)]);
                            i4 += 3;
                            i2 += SKIP_CODE;
                        }
                        annotationVisitor.visit(str, obj);
                    ...
                    case Opcodes.AASTORE /*83*/:
                        ...
                        while (i2 < readUnsignedShort) {
                            obj[i2] = (short) readInt(this.f1677a[readUnsignedShort(i4)]);
                            i4 += 3;
                            i2 += SKIP_CODE;
                        }
                        annotationVisitor.visit(str, obj);
                    ...
                    case Opcodes.DUP_X1 /*90*/:
                        ...
                        for (i3 = 0; i3 < readUnsignedShort; i3 += SKIP_CODE) {
                            obj2[i3] = readInt(this.f1677a[readUnsignedShort(i5)]) != 0;
                            i5 += 3;
                        }
                        annotationVisitor.visit(str, obj2);
                        return i5 - 1;
                    default:
                        return m1719a(i4 - 3, cArr, false, annotationVisitor.visitArray(str));
                }
    ...
    private int m1719a(int i, char[] cArr, boolean z, AnnotationVisitor annotationVisitor) {
        ...
        if (z) {
            ...
            while (i2 > 0) {
                i2--;
                readUnsignedShort = m1718a(readUnsignedShort + SKIP_DEBUG, cArr, readUTF8(readUnsignedShort, cArr), annotationVisitor);
            }
        } else {
            i3 = readUnsignedShort;
            readUnsignedShort = i2;
            ...
            while (i2 > 0) {
                i2--;
                readUnsignedShort = m1718a(readUnsignedShort, cArr, null, annotationVisitor);
            }
        }
        if (annotationVisitor != null) {
    ...
    private int m1720a(Object[] objArr, int i, int i2, char[] cArr, Label[] labelArr) {
        int i3 = i2 + SKIP_CODE;
        switch (this.f1678b[i2] & KEYRecord.PROTOCOL_ANY) {
    ...
    private String m1721a(int i, int i2, char[] cArr) {
        int i3 = i + i2;
        byte[] bArr = this.f1678b;
        int i4 = 0;
        int i5 = 0;
        int i6 = 0;
        while (i < i3) {
            ...
            switch (i5) {
                case KEYRecord.OWNER_USER /*0*/:
                    int i9 = b & KEYRecord.PROTOCOL_ANY;
                    if (i9 >= Flags.FLAG8) {
    ...
    private Attribute m1722a(Attribute[] attributeArr, String str, int i, int i2, char[] cArr, int i3, Label[] labelArr) {
    ...
    private void m1723a(int i, String str, char[] cArr, boolean z, MethodVisitor methodVisitor) {
        int i2 = i + SKIP_CODE;
        int i3 = this.f1678b[i] & KEYRecord.PROTOCOL_ANY;
        ...
        for (int i5 = i4; i5 < i3 + length; i5 += SKIP_CODE) {
            ...
            for (i4 = readUnsignedShort(i2); i4 > 0; i4--) {
                i2 = m1719a(i2 + SKIP_DEBUG, cArr, true, methodVisitor.visitParameterAnnotation(i5, readUTF8(i2, cArr), z));
            }
        }
    }

    private static byte[] m1724a(InputStream inputStream) throws IOException {
        if (inputStream == null) {
    ...
    void m1725a(ClassWriter classWriter) {
        int i;
        char[] cArr = new char[this.f1680d];
        int length = this.f1677a.length;
        Item[] itemArr = new Item[length];
        int i2 = SKIP_CODE;
        while (i2 < length) {
            i = this.f1677a[i2];
            byte b = this.f1678b[i - 1];
            Item item = new Item(i2);
            switch (b) {
                case SKIP_CODE /*1*/:
                    String str = this.f1679c[i2];
                    if (str == null) {
                        i = this.f1677a[i2];
                        String[] strArr = this.f1679c;
                        str = m1721a(i + SKIP_DEBUG, readUnsignedShort(i), cArr);
                        strArr[i2] = str;
                    }
                    item.m1743a(b, str, null, null);
                    i = i2;
                    break;
                case FieldOptions.DEPRECATED_FIELD_NUMBER /*3*/:
                    item.m1742a(readInt(i));
                    i = i2;
                    break;
                case SKIP_FRAMES /*4*/:
                    item.m1741a(Float.intBitsToFloat(readInt(i)));
                    i = i2;
                    break;
                case UninterpretedOption.NEGATIVE_INT_VALUE_FIELD_NUMBER /*5*/:
                    item.m1744a(readLong(i));
                    i = i2 + SKIP_CODE;
                    break;
                case UninterpretedOption.DOUBLE_VALUE_FIELD_NUMBER /*6*/:
                    item.m1740a(Double.longBitsToDouble(readLong(i)));
                    i = i2 + SKIP_CODE;
                    break;
                case FileOptions.OPTIMIZE_FOR_FIELD_NUMBER /*9*/:
                case FileOptions.JAVA_MULTIPLE_FILES_FIELD_NUMBER /*10*/:
                case TrafficIncident.LOCATION_FIELD_NUMBER /*11*/:
                    int i3 = this.f1677a[readUnsignedShort(i + SKIP_DEBUG)];
                    item.m1743a(b, readClass(i, cArr), readUTF8(i3, cArr), readUTF8(i3 + SKIP_DEBUG, cArr));
                    i = i2;
                    break;
                case TrafficIncident.VERTEXOFFSET_FIELD_NUMBER /*12*/:
                    item.m1743a(b, readUTF8(i, cArr), readUTF8(i + SKIP_DEBUG, cArr), null);
                    i = i2;
                    break;
                default:
                    item.m1743a(b, readUTF8(i, cArr), null, null);
                    i = i2;
                    break;
            }
            i2 = item.f1706j % itemArr.length;
            item.f1707k = itemArr[i2];
            itemArr[i2] = item;
            i2 = i + SKIP_CODE;
        }
        i = this.f1677a[SKIP_CODE] - 1;
        classWriter.f2262d.putByteArray(this.f1678b, i, this.header - i);
        classWriter.f2263e = itemArr;
        classWriter.f2264f = (int) (0.75d * ((double) length));
        classWriter.f2261c = length;
    }
    ...
    L_0x026f:
        ...
        r4 = r48;
        r5 = r50;
        r4 = r4.m1722a(r5, r6, r7, r8, r9, r10, r11);
    ...
    L_0x07c2:
        ...
        r4 = r41[r5];
        r4 = r4 & 255;
        r6 = org.codehaus.jackson.org.objectweb.asm.ClassWriter.f2250a;
        r4 = r6[r4];
        switch(r4) {
    ...
    L_0x0bd0:
        ...
        r15 = r48;
        r19 = r9;
        r18 = r15.m1720a(r16, r17, r18, r19, r20);
        r7 = 4;
        r5 = 1;
        goto L_0x0b9d;
    L_0x0bdf:
    ...
    L_0x0c87:
        r4 = r41[r33];
        r8 = r4 & 255;
        r4 = org.codehaus.jackson.org.objectweb.asm.ClassWriter.f2250a;
        r4 = r4[r8];
        switch(r4) {
    ...
    public String getClassName() {
        return readClass(this.header + SKIP_DEBUG, new char[this.f1680d]);
    }
    ...
    public String getSuperName() {
        int i = this.f1677a[readUnsignedShort(this.header + SKIP_FRAMES)];
        return i == 0 ? null : readUTF8(i, new char[this.f1680d]);
    }

    public int readByte(int i) {
        return this.f1678b[i] & KEYRecord.PROTOCOL_ANY;
    }

    public String readClass(int i, char[] cArr) {
        return readUTF8(this.f1677a[readUnsignedShort(i)], cArr);
    }

    public Object readConst(int i, char[] cArr) {
        int i2 = this.f1677a[i];
        switch (this.f1678b[i2 - 1]) {
            case FieldOptions.DEPRECATED_FIELD_NUMBER /*3*/:
    ...
    public int readInt(int i) {
        byte[] bArr = this.f1678b;
        return (bArr[i + 3] & KEYRecord.PROTOCOL_ANY) | ((((bArr[i] & KEYRecord.PROTOCOL_ANY) << 24) | ((bArr[i + SKIP_CODE] & KEYRecord.PROTOCOL_ANY) << 16)) | ((bArr[i + SKIP_DEBUG] & KEYRecord.PROTOCOL_ANY) << EXPAND_FRAMES));
    }
    ...
    public long readLong(int i) {
        return (((long) readInt(i)) << 32) | (((long) readInt(i + SKIP_FRAMES)) & Util.MAX_32BIT_VALUE);
    }

    public short readShort(int i) {
        byte[] bArr = this.f1678b;
        return (short) ((bArr[i + SKIP_CODE] & KEYRecord.PROTOCOL_ANY) | ((bArr[i] & KEYRecord.PROTOCOL_ANY) << EXPAND_FRAMES));
    }

    public String readUTF8(int i, char[] cArr) {
        int readUnsignedShort = readUnsignedShort(i);
        String str = this.f1679c[readUnsignedShort];
        if (str != null) {
            return str;
        }
        int i2 = this.f1677a[readUnsignedShort];
        String[] strArr = this.f1679c;
        str = m1721a(i2 + SKIP_DEBUG, readUnsignedShort(i2), cArr);
    ...
    public int readUnsignedShort(int i) {
        byte[] bArr = this.f1678b;
        return (bArr[i + SKIP_CODE] & KEYRecord.PROTOCOL_ANY) | ((bArr[i] & KEYRecord.PROTOCOL_ANY) << EXPAND_FRAMES);
    }
}
