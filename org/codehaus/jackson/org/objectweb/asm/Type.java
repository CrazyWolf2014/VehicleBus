...
public class Type {
    ...
    private static org.codehaus.jackson.org.objectweb.asm.Type m1754a(char[] r4, int r5) {
        /*
        r3 = 59;
        r0 = 1;
        r1 = r4[r5];
    ...
    private void m1755a(StringBuffer stringBuffer) {
        if (this.f1720b == null) {
            stringBuffer.append((char) ((this.f1721c & DefaultRenderer.BACKGROUND_COLOR) >>> 24));
        } else if (this.f1719a == ARRAY) {
            stringBuffer.append(this.f1720b, this.f1721c, this.f1722d);
        } else {
    ...
    private static void m1756a(StringBuffer stringBuffer, Class cls) {
        char charAt;
    ...
    public static Type[] getArgumentTypes(String str) {
        ...
        i2 = 0;
        while (toCharArray[i] != ')') {
            typeArr[i2] = m1754a(toCharArray, i);
            i += (typeArr[i2].f1719a == OBJECT ? CHAR : 0) + typeArr[i2].f1722d;
            i2 += BOOLEAN;
        }
        return typeArr;
    }
    ...
    public static String getConstructorDescriptor(Constructor constructor) {
        ...
        for (int i = 0; i < parameterTypes.length; i += BOOLEAN) {
            m1756a(stringBuffer, parameterTypes[i]);
        }
    ...
    public static String getMethodDescriptor(Method method) {
        ...
        stringBuffer.append(')');
        m1756a(stringBuffer, method.getReturnType());
        return stringBuffer.toString();
    }
    ...
    public static String getMethodDescriptor(Type type, Type[] typeArr) {
        ...
        for (int i = 0; i < typeArr.length; i += BOOLEAN) {
            typeArr[i].m1755a(stringBuffer);
        }
        stringBuffer.append(')');
        type.m1755a(stringBuffer);
        return stringBuffer.toString();
    }
    ...
    public static Type getReturnType(String str) {
        return m1754a(str.toCharArray(), str.indexOf(41) + BOOLEAN);
    }
    ...
    public static Type getType(String str) {
        return m1754a(str.toCharArray(), 0);
    }
    ...
    public boolean equals(Object obj) {
        ...
        Type type = (Type) obj;
        if (this.f1719a != type.f1719a) {
            return false;
        }
        if (this.f1719a != OBJECT && this.f1719a != ARRAY) {
            return true;
        }
        if (this.f1722d != type.f1722d) {
            return false;
        }
        int i = this.f1721c;
        int i2 = type.f1721c;
        int i3 = this.f1722d + i;
        while (i < i3) {
            if (this.f1720b[i] != type.f1720b[i2]) {
                return false;
            }
            i += BOOLEAN;
            i2 += BOOLEAN;
    ...
    public String getClassName() {
        switch (this.f1719a) {
            ...
            case ARRAY /*9*/:
                ...
                return stringBuffer.toString();
            default:
                return new String(this.f1720b, this.f1721c, this.f1722d).replace('/', '.');
        }
    }
    ...
    public int getDimensions() {
        int i = BOOLEAN;
        while (this.f1720b[this.f1721c + i] == '[') {
            i += BOOLEAN;
        }
        return i;
    }
    ...
    public Type getElementType() {
        return m1754a(this.f1720b, this.f1721c + getDimensions());
    }

    public String getInternalName() {
        return new String(this.f1720b, this.f1721c, this.f1722d);
    }
    ...
    public int getOpcode(int i) {
        ...
        if (i == 46 || i == 79) {
            if (this.f1720b == null) {
                i2 = (this.f1721c & MotionEventCompat.ACTION_POINTER_INDEX_MASK) >> DOUBLE;
            }
            return i2 + i;
        }
        if (this.f1720b == null) {
            i2 = (this.f1721c & 16711680) >> 16;
        }
        return i2 + i;
    }

    public int getSize() {
        return this.f1720b == null ? this.f1721c & KEYRecord.PROTOCOL_ANY : BOOLEAN;
    }
    ...
    public int hashCode() {
        int i = this.f1719a * 13;
        if (this.f1719a == OBJECT || this.f1719a == ARRAY) {
            int i2 = this.f1721c;
            int i3 = i2 + this.f1722d;
            while (i2 < i3) {
                int i4 = (i + this.f1720b[i2]) * 17;
                i2 += BOOLEAN;
                i = i4;
            }
        }
