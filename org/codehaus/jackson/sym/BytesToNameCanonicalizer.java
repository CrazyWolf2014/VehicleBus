...
public final class BytesToNameCanonicalizer {
    ...
    private void _addSymbol(int hash, Name symbol) {
        ...
        if (this._mainNames[ix] == null) {
            ...
            int bucket = entryValue & KEYRecord.PROTOCOL_ANY;
            if (bucket == 0) {
    ...
    private void rehash() {
        ...
        if (oldEnd != 0) {
            ...
            for (i = 0; i < oldEnd; i++) {
                for (Bucket curr = oldBuckets[i]; curr != null; curr = curr._next) {
                    ...
                    if (this._mainNames[ix] == null) {
                        ...
                        this._collCount++;
                        int bucket = val & KEYRecord.PROTOCOL_ANY;
                        if (bucket == 0) {
                            i2 = this._collEnd;
            ...
            if (symbolsSeen != r0) {
                ...
                throw new RuntimeException(r17.append(symbolsSeen).append("; should be ").append(this._count).toString());
            }
        }
    }
