...
public final class JsonStringEncoder {
    ...
    L_0x0010:
        ...
        r4 = org.codehaus.jackson.util.CharTypes.getOutputEscapes();
        r3 = r4.length;
        r6 = 0;
        r8 = r18.length();
        r10 = 0;
    ...
    L_0x001a:
        r2 = org.codehaus.jackson.util.CharTypes.getOutputEscapes();
    L_0x001e:
        r1 = r13.charAt(r5);
    ...
    L_0x0038:
        r3 = r2[r1];
        r8 = r12._appendByteEscape(r3, r0, r8);
    ...
    public byte[] encodeAsUTF8(String text) {
        ...
        while (inputPtr2 < inputEnd) {
            ...
            if (c < Flags.FLAG4) {
                ...
                outputBuffer[outputPtr2] = (byte) ((c >> 6) | Wbxml.EXT_0);
                inputPtr = inputPtr2;
            } else if (c < SURR1_FIRST || c > SURR2_LAST) {
                outputPtr = outputPtr2 + 1;
                outputBuffer[outputPtr2] = (byte) ((c >> 12) | SmileConstants.TOKEN_PREFIX_MISC_OTHER);
                if (outputPtr >= outputEnd) {
                    outputBuffer = byteBuilder.finishCurrentSegment();
                    outputEnd = outputBuffer.length;
                    outputPtr = 0;
                ...
                outputPtr2 = outputPtr + 1;
                outputBuffer[outputPtr] = (byte) (((c >> 6) & 63) | Flags.FLAG8);
                outputPtr = outputPtr2;
                inputPtr = inputPtr2;
            } else {
                if (c > SURR1_LAST) {
                ...
                outputPtr2 = outputPtr + 1;
                outputBuffer[outputPtr] = (byte) (((c >> 12) & 63) | Flags.FLAG8);
            ...
            outputPtr2 = outputPtr + 1;
            outputBuffer[outputPtr] = (byte) ((c & 63) | Flags.FLAG8);
            outputPtr = outputPtr2;
            inputPtr2 = inputPtr;
        }
        inputPtr = inputPtr2;
    ...
    private int _appendByteEscape(int escCode, ByteArrayBuilder byteBuilder, int ptr) {
        ...
        if (escCode < 0) {
            ...
            byteBuilder.append(HEX_BYTES[value & 15]);
        } else {
