...
public final class UTF8Writer extends Writer {
    ...
    public void write(char[] cbuf, int off, int len) throws IOException {
        if (len >= 2) {
            ...
            while (off2 < len) {
                ...
                if (c < Flags.FLAG4) {
                    outPtr = outPtr2 + 1;
                    outBuf[outPtr2] = (byte) ((c >> 6) | Wbxml.EXT_0);
                    outPtr2 = outPtr + 1;
                    outBuf[outPtr] = (byte) ((c & 63) | Flags.FLAG8);
                    outPtr = outPtr2;
                    off = off2;
                } else if (c < SURR1_FIRST || c > SURR2_LAST) {
                    outPtr = outPtr2 + 1;
                    outBuf[outPtr2] = (byte) ((c >> 12) | SmileConstants.TOKEN_PREFIX_MISC_OTHER);
                    outPtr2 = outPtr + 1;
                    outBuf[outPtr] = (byte) (((c >> 6) & 63) | Flags.FLAG8);
                    outPtr = outPtr2 + 1;
                    outBuf[outPtr2] = (byte) ((c & 63) | Flags.FLAG8);
                } else {
                    if (c > SURR1_LAST) {
                    ...
                    outPtr2 = outPtr + 1;
                    outBuf[outPtr] = (byte) (((c >> 12) & 63) | Flags.FLAG8);
                    outPtr = outPtr2 + 1;
                    outBuf[outPtr2] = (byte) (((c >> 6) & 63) | Flags.FLAG8);
                    outPtr2 = outPtr + 1;
                    outBuf[outPtr] = (byte) ((c & 63) | Flags.FLAG8);
                    outPtr = outPtr2;
                }
    ...
    public void write(int c) throws IOException {
        ...
        if (c < Flags.FLAG4) {
            i3 = i2 + 1;
            this._outBuffer[i2] = (byte) ((c >> 6) | Wbxml.EXT_0);
            i2 = i3 + 1;
            this._outBuffer[i3] = (byte) ((c & 63) | Flags.FLAG8);
        } else if (c <= InBandBytestreamManager.MAXIMUM_BLOCK_SIZE) {
            i3 = i2 + 1;
            this._outBuffer[i2] = (byte) ((c >> 12) | SmileConstants.TOKEN_PREFIX_MISC_OTHER);
            i2 = i3 + 1;
            this._outBuffer[i3] = (byte) (((c >> 6) & 63) | Flags.FLAG8);
            i3 = i2 + 1;
            this._outBuffer[i2] = (byte) ((c & 63) | Flags.FLAG8);
            i2 = i3;
        } else {
            if (c > 1114111) {
                throwIllegal(c);
            ...
            i2 = i3 + 1;
            this._outBuffer[i3] = (byte) (((c >> 12) & 63) | Flags.FLAG8);
            i3 = i2 + 1;
            this._outBuffer[i2] = (byte) (((c >> 6) & 63) | Flags.FLAG8);
            i2 = i3 + 1;
            this._outBuffer[i3] = (byte) ((c & 63) | Flags.FLAG8);
        }
        this._outPtr = i2;
