...
public class JacksonJsonProvider implements MessageBodyReader<Object>, MessageBodyWriter<Object>, Versioned {
    ...
    public boolean isReadable(Class<?> type, Type genericType, Annotation[] annotations, MediaType mediaType) {
        ...
        if (!this._cfgCheckCanSerialize || locateMapper(type, mediaType).canDeserialize(_convertType(type))) {
            return true;
        }
        return false;
    }

    public Object readFrom(Class<Object> type, Type genericType, Annotation[] annotations, MediaType mediaType, MultivaluedMap<String, String> multivaluedMap, InputStream entityStream) throws IOException {
    ...
    public long getSize(Object value, Class<?> cls, Type genericType, Annotation[] annotations, MediaType mediaType) {
        return -1;
    }
    ...
    public boolean isWriteable(Class<?> type, Type genericType, Annotation[] annotations, MediaType mediaType) {
        ...
        if (!this._cfgCheckCanSerialize || locateMapper(type, mediaType).canSerialize(type)) {
            return true;
        }
        return false;
    }
