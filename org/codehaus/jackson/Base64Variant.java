...
public final class Base64Variant {
    ...
    public Base64Variant(String name, String base64Alphabet, boolean usesPadding, char paddingChar, int maxLineLength) {
        this._asciiToBase64 = new int[Flags.FLAG8];
    ...
    public int decodeBase64Char(char c) {
        char ch = c;
        return ch <= Service.LOCUS_CON ? this._asciiToBase64[ch] : BASE64_VALUE_INVALID;
    }
    ...
    public String encode(byte[] input, boolean addQuotes) {
        ...
        while (inputPtr <= safeInputEnd) {
            ...
            encodeBase64Chunk(sb, (((input[inputPtr] << 8) | (input[inputPtr2] & KEYRecord.PROTOCOL_ANY)) << 8) | (input[inputPtr] & KEYRecord.PROTOCOL_ANY));
        ...
        if (inputLeft > 0) {
            ...
            if (inputLeft == 2) {
                b24 |= (input[inputPtr2] & KEYRecord.PROTOCOL_ANY) << 8;
                inputPtr2++;
            }
