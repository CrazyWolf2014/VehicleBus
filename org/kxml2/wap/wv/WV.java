...
public abstract class WV {
    ...
    static {
        tagTablePage0 = new String[]{"Acceptance", "AddList", "AddNickList", "SName", "WV-CSP-Message", "ClientID", "Code", "ContactList", "ContentData", "ContentEncoding", "ContentSize", "ContentType", "DateTime", "Description", "DetailedResult", "EntityList", "Group", "GroupID", "GroupList", "InUse", "Logo", "MessageCount", "MessageID", "MessageURI", "MSISDN", Constants.VEHICLE_INI_SECTION_NAME, "NickList", "NickName", "Poll", "Presence", "PresenceSubList", "PresenceValue", "Property", "Qualifier", "Recipient", "RemoveList", "RemoveNickList", "Result", "ScreenName", "Sender", "Session", "SessionDescriptor", "SessionID", "SessionType", "Status", "Transaction", "TransactionContent", "TransactionDescriptor", "TransactionID", "TransactionMode", AlixDefine.URL, "URLList", "User", "UserID", "UserList", "Validity", "Value"};
        ...
        tagTablePage5 = new String[]{"Accuracy", "Address", "AddrPref", "Alias", "Altitude", "Building", "Caddr", "City", "ClientInfo", "ClientProducer", "ClientType", "ClientVersion", "CommC", "CommCap", "ContactInfo", "ContainedvCard", MySharedPreferences.whoCountry, "Crossing1", "Crossing2", "DevManufacturer", "DirectContent", "FreeTextLocation", "GeoLocation", "Language", "Latitude", "Longitude", "Model", "NamedArea", "OnlineStatus", "PLMN", "PrefC", "PreferredContacts", "PreferredLanguage", "PreferredContent", "PreferredvCard", "Registration", "StatusContent", "StatusMood", "StatusText", "Street", "TimeZone", "UserAvailability", "Cap", "Cname", "Contact", "Cpriority", "Cstatus", "Note", "Zone", null, "Inf_link", "InfoLink", "Link", "Text"};
        ...
        strArr[20] = "Mod";
        strArr[21] = Constants.VEHICLE_INI_SECTION_NAME;
        strArr[22] = "None";
        strArr[23] = "N";
        strArr[24] = "Open";
        strArr[25] = "Outband";
        ...
        strArr[43] = "Topic";
        strArr[44] = NDEFRecord.TEXT_WELL_KNOWN_TYPE;
        strArr[45] = "Type";
        strArr[46] = NDEFRecord.URI_WELL_KNOWN_TYPE;
        strArr[47] = "US";
        ...
        strArr[99] = "COMPUTER";
        strArr[100] = "DISCREET";
        strArr[Service.HOSTNAME] = "EMAIL";
        strArr[Service.ISO_TSAP] = "EXCITED";
        strArr[Service.X400] = "HAPPY";
        strArr[Service.X400_SND] = "IM";
        strArr[Service.CSNET_NS] = "IM_OFFLINE";
        strArr[Opcodes.FMUL] = "IM_ONLINE";
        strArr[Service.RTELNET] = "IN_LOVE";
        strArr[Opcodes.IDIV] = "INVINCIBLE";
        strArr[Service.POP_2] = "JEALOUS";
        strArr[SoapEnvelope.VER11] = "MMS";
        strArr[Service.SUNRPC] = "MOBILE_PHONE";
        strArr[Opcodes.IREM] = "NOT_AVAILABLE";
        strArr[Service.AUTH] = "OTHER";
        strArr[Opcodes.FREM] = "PDA";
        strArr[Service.SFTP] = "SAD";
        strArr[Opcodes.INEG] = "SLEEPY";
        strArr[Service.UUCP_PATH] = "SMS";
        strArr[Opcodes.FNEG] = "VIDEO_CALL";
        strArr[Service.NNTP] = "VIDEO_STREAM";
