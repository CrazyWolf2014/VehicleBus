...
public class FragmentActivity extends Activity {
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (index != 0) {
            ...
            if (frag == null) {
                ...
                frag.onActivityResult(InBandBytestreamManager.MAXIMUM_BLOCK_SIZE & requestCode, resultCode, data);
                return;
            }
        }
    ...
    public void startActivityFromFragment(Fragment fragment, Intent intent, int requestCode) {
        if (requestCode == -1) {
            ...
            super.startActivityForResult(intent, ((fragment.mIndex + MSG_REALLY_STOPPED) << 16) + (InBandBytestreamManager.MAXIMUM_BLOCK_SIZE & requestCode));
        }
    }
