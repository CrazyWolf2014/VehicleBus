...
public class PagerTabStrip extends PagerTitleStrip {
    ...
    public PagerTabStrip(Context context, AttributeSet attrs) {
        ...
        this.mTabAlpha = KEYRecord.PROTOCOL_ANY;
        ...
        this.mPrevText.setOnClickListener(new C00131());
        this.mNextText.setFocusable(true);
        this.mNextText.setOnClickListener(new C00142());
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (this.mDrawFullUnderline) {
            this.mTabPaint.setColor(DefaultRenderer.BACKGROUND_COLOR | (this.mIndicatorColor & 16777215));
