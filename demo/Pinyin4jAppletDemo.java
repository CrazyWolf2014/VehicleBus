...
public class Pinyin4jAppletDemo extends JApplet {
    ...
    final class C09111 extends WindowAdapter {
        private final Pinyin4jAppletDemo val$appletDemo;

        C09111(Pinyin4jAppletDemo pinyin4jAppletDemo) {
    ...
    final class C09122 implements ActionListener {
        private final Pinyin4jAppletDemo this$0;

        C09122(Pinyin4jAppletDemo pinyin4jAppletDemo) {
    ...
    final class C09133 implements ActionListener {
        private final Pinyin4jAppletDemo this$0;

        C09133(Pinyin4jAppletDemo pinyin4jAppletDemo) {
            this.this$0 = pinyin4jAppletDemo;
        }
    ...
    static {
        APP_SIZE = new Dimension(600, MyHttpException.ERROR_PARAMETER);
    ...
    private JButton getConvertButton() {
        if (this.convertButton == null) {
            ...
            this.convertButton.addActionListener(new C09122(this));
        }
    ...
    private JComboBox getToneTypesComboBox() {
        if (this.toneTypesComboBox == null) {
            ...
            this.toneTypesComboBox.addActionListener(new C09133(this));
        }
    ...
    public static void main(String[] strArr) {
        ...
        jFrame.addWindowListener(new C09111(pinyin4jAppletDemo));
