...
public class ExpandedProductParsedResult extends ParsedResult {
    ...
    ExpandedProductParsedResult() {
        ...
        this.sscc = XmlPullParser.NO_NAMESPACE;
        this.lotNumber = XmlPullParser.NO_NAMESPACE;
        this.productionDate = XmlPullParser.NO_NAMESPACE;
        this.packagingDate = XmlPullParser.NO_NAMESPACE;
        this.bestBeforeDate = XmlPullParser.NO_NAMESPACE;
        this.expirationDate = XmlPullParser.NO_NAMESPACE;
        this.weight = XmlPullParser.NO_NAMESPACE;
        this.weightType = XmlPullParser.NO_NAMESPACE;
        this.weightIncrement = XmlPullParser.NO_NAMESPACE;
        this.price = XmlPullParser.NO_NAMESPACE;
        this.priceIncrement = XmlPullParser.NO_NAMESPACE;
        this.priceCurrency = XmlPullParser.NO_NAMESPACE;
