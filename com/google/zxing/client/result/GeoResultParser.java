...
final class GeoResultParser extends ResultParser {
    ...
    public static GeoParsedResult parse(Result result) {
        ...
        try {
            ...
            return (parseDouble2 > VMapProjection.MaxLongitude || parseDouble2 < VMapProjection.MinLongitude || d < 0.0d) ? null : new GeoParsedResult(parseDouble, parseDouble2, d, str);
