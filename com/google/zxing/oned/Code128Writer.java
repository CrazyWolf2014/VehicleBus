...
public final class Code128Writer extends UPCEANWriter {
    ...
    public byte[] encode(String str) {
        ...
        i2 = UPCEANWriter.appendPattern(bArr, 0, Code128Reader.CODE_PATTERNS[Service.X400_SND], 1);
        i3 = Service.X400_SND;
        while (i < length) {
        ...
        i3 = UPCEANWriter.appendPattern(bArr, i2, Code128Reader.CODE_PATTERNS[i3 % Service.X400], 1) + i2;
