...
public final class Code93Reader extends OneDReader {
    ...
    static {
        ...
        CHARACTER_ENCODINGS = new int[]{276, 328, 324, 322, 296, 292, 290, 336, 274, 266, 424, 420, 418, 404, MyHttpException.ERROR_PARAMETER_ILLEGAL, MyHttpException.ERROR_USERPHONE_FORM, 360, 356, 354, 308, 282, 344, 332, 326, JniX431File.MAX_DS_COLNUMBER, 278, 436, 434, 428, 422, 406, 410, 364, 358, 310, 314, 302, 468, 466, 458, 366, 374, 430, 294, 474, 470, 306, 350};
    ...
    private static int toPattern(int[] iArr) {
        ...
        for (int i3 = 0; i3 < length; i3++) {
            ...
            int i5 = i4 >> 8;
            int i6 = (i4 & KEYRecord.PROTOCOL_ANY) > Service.LOCUS_CON ? i5 + 1 : i5;
            if (i6 < 1 || i6 > 4) {
                return -1;
            }
            if ((i3 & 1) == 0) {
    ...
    public com.google.zxing.Result decodeRow(int r10, com.google.zxing.common.BitArray r11, java.util.Hashtable r12) throws com.google.zxing.NotFoundException, com.google.zxing.ChecksumException, com.google.zxing.FormatException {
        /*
        r9 = this;
