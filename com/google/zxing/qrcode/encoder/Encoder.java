...
public final class Encoder {
    ...
    static void appendKanjiBytes(String str, BitArray bitArray) throws WriterException {
        try {
            ...
            for (int i = 0; i < length; i += 2) {
                int i2 = ((bytes[i] & KEYRecord.PROTOCOL_ANY) << 8) | (bytes[i + 1] & KEYRecord.PROTOCOL_ANY);
                i2 = (i2 < 33088 || i2 > 40956) ? (i2 < 57408 || i2 > 60351) ? -1 : i2 - 49472 : i2 - 33088;
                if (i2 == -1) {
                    throw new WriterException("Invalid byte sequence");
                }
                bitArray.appendBits((i2 & KEYRecord.PROTOCOL_ANY) + ((i2 >> 8) * Wbxml.EXT_0), 13);
            }
        } catch (UnsupportedEncodingException e) {
            throw new WriterException(e.toString());
        }
    ...
    private static boolean isOnlyDoubleByteKanji(String str) {
        try {
            ...
            for (int i = 0; i < length; i += 2) {
                int i2 = bytes[i] & KEYRecord.PROTOCOL_ANY;
                if ((i2 < Service.PWDGEN || i2 > Opcodes.IF_ICMPEQ) && (i2 < SmileConstants.TOKEN_PREFIX_MISC_OTHER || i2 > 235)) {
                    return false;
                }
            }
            return true;
