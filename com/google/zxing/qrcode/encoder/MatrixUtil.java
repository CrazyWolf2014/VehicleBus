...
public final class MatrixUtil {
    ...
    static {
        ...
        POSITION_ADJUSTMENT_PATTERN_COORDINATE_TABLE = new int[][]{new int[]{-1, -1, -1, -1, -1, -1, -1}, new int[]{6, 18, -1, -1, -1, -1, -1}, new int[]{6, 22, -1, -1, -1, -1, -1}, new int[]{6, 26, -1, -1, -1, -1, -1}, new int[]{6, 30, -1, -1, -1, -1, -1}, new int[]{6, 34, -1, -1, -1, -1, -1}, new int[]{6, 22, 38, -1, -1, -1, -1}, new int[]{6, 24, 42, -1, -1, -1, -1}, new int[]{6, 26, 46, -1, -1, -1, -1}, new int[]{6, 28, 50, -1, -1, -1, -1}, new int[]{6, 30, 54, -1, -1, -1, -1}, new int[]{6, 32, 58, -1, -1, -1, -1}, new int[]{6, 34, 62, -1, -1, -1, -1}, new int[]{6, 26, 46, 66, -1, -1, -1}, new int[]{6, 26, 48, 70, -1, -1, -1}, new int[]{6, 26, 50, 74, -1, -1, -1}, new int[]{6, 30, 54, 78, -1, -1, -1}, new int[]{6, 30, 56, 82, -1, -1, -1}, new int[]{6, 30, 58, 86, -1, -1, -1}, new int[]{6, 34, 62, 90, -1, -1, -1}, new int[]{6, 28, 50, 72, 94, -1, -1}, new int[]{6, 26, 50, 74, 98, -1, -1}, new int[]{6, 30, 54, 78, Service.ISO_TSAP, -1, -1}, new int[]{6, 28, 54, 80, Opcodes.FMUL, -1, -1}, new int[]{6, 32, 58, 84, SoapEnvelope.VER11, -1, -1}, new int[]{6, 30, 58, 86, Opcodes.FREM, -1, -1}, new int[]{6, 34, 62, 90, Opcodes.FNEG, -1, -1}, new int[]{6, 26, 50, 74, 98, Opcodes.ISHR, -1}, new int[]{6, 30, 54, 78, Service.ISO_TSAP, Opcodes.IAND, -1}, new int[]{6, 26, 52, 78, Service.X400_SND, Service.CISCO_FNA, -1}, new int[]{6, 30, 56, 82, Opcodes.IDIV, Service.INGRES_NET, -1}, new int[]{6, 34, 60, 86, Opcodes.IREM, Service.NETBIOS_DGM, -1}, new int[]{6, 30, 58, 86, Opcodes.FREM, Service.BL_IDM, -1}, new int[]{6, 34, 62, 90, Opcodes.FNEG, Opcodes.I2C, -1}, new int[]{6, 30, 54, 78, Service.ISO_TSAP, Opcodes.IAND, Opcodes.FCMPG}, new int[]{6, 24, 50, 76, Service.ISO_TSAP, Flags.FLAG8, Opcodes.IFNE}, new int[]{6, 28, 54, 80, Opcodes.FMUL, Service.CISCO_SYS, Opcodes.IFLE}, new int[]{6, 32, 58, 84, SoapEnvelope.VER11, Service.PROFILE, Opcodes.IF_ICMPGE}, new int[]{6, 26, 54, 82, SoapEnvelope.VER11, Service.NETBIOS_DGM, Opcodes.IF_ACMPNE}, new int[]{6, 30, 58, 86, Opcodes.FREM, Service.BL_IDM, Opcodes.TABLESWITCH}};
