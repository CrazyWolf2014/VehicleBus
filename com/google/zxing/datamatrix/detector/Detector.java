...
public final class Detector {
    ...
    private static class ResultPointsAndTransitions {
        ...
        ResultPointsAndTransitions(ResultPoint resultPoint, ResultPoint resultPoint2, int i, C02411 c02411) {
        ...
        public String toString() {
            return new StringBuffer().append(this.from).append(FilePathGenerator.ANDROID_DIR_SEP).append(this.to).append('/').append(this.transitions).toString();
        }
    }
    ...
    private static class ResultPointsAndTransitionsComparator implements Comparator {
        ...
        ResultPointsAndTransitionsComparator(C02411 c02411) {
            this();
        }
