...
public final class GF256 {
    ...
    private GF256(int i) {
        this.expTable = new int[KEYRecord.OWNER_ZONE];
        this.logTable = new int[KEYRecord.OWNER_ZONE];
        int i2 = 1;
        for (int i3 = 0; i3 < KEYRecord.OWNER_ZONE; i3++) {
            this.expTable[i3] = i2;
            i2 <<= 1;
            if (i2 >= KEYRecord.OWNER_ZONE) {
                i2 ^= i;
            }
        }
        for (i2 = 0; i2 < KEYRecord.PROTOCOL_ANY; i2++) {
    ...
    int multiply(int i, int i2) {
        ...
        return this.expTable[(i3 >>> 8) + (i3 & KEYRecord.PROTOCOL_ANY)];
    }
}
