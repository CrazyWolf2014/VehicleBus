...
public final class CodedOutputStream {
    ...
    public void writeRawVarint32(int i) throws IOException {
        while ((i & -128) != 0) {
            writeRawByte((i & Service.LOCUS_CON) | Flags.FLAG8);
            i >>>= 7;
        }
        writeRawByte(i);
    }
    ...
    public void writeRawVarint64(long j) throws IOException {
        while ((-128 & j) != 0) {
            writeRawByte((((int) j) & Service.LOCUS_CON) | Flags.FLAG8);
            j >>>= 7;
        }
        writeRawByte((int) j);
    }
    ...
    public void writeRawLittleEndian32(int i) throws IOException {
        writeRawByte(i & KEYRecord.PROTOCOL_ANY);
        writeRawByte((i >> LITTLE_ENDIAN_64_SIZE) & KEYRecord.PROTOCOL_ANY);
        writeRawByte((i >> 16) & KEYRecord.PROTOCOL_ANY);
        writeRawByte((i >> 24) & KEYRecord.PROTOCOL_ANY);
    }

    public void writeRawLittleEndian64(long j) throws IOException {
        writeRawByte(((int) j) & KEYRecord.PROTOCOL_ANY);
        writeRawByte(((int) (j >> LITTLE_ENDIAN_64_SIZE)) & KEYRecord.PROTOCOL_ANY);
        writeRawByte(((int) (j >> 16)) & KEYRecord.PROTOCOL_ANY);
        writeRawByte(((int) (j >> 24)) & KEYRecord.PROTOCOL_ANY);
        writeRawByte(((int) (j >> 32)) & KEYRecord.PROTOCOL_ANY);
        writeRawByte(((int) (j >> 40)) & KEYRecord.PROTOCOL_ANY);
        writeRawByte(((int) (j >> 48)) & KEYRecord.PROTOCOL_ANY);
        writeRawByte(((int) (j >> 56)) & KEYRecord.PROTOCOL_ANY);
    }
