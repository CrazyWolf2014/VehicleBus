...
public class PublicListViewNoFoot extends ListView implements OnScrollListener {
    ...
    /* renamed from: com.ifoer.view.PublicListViewNoFoot.1 */
    class C07761 implements OnClickListener {
        C07761() {
        }

        public void onClick(View v) {
            PublicListViewNoFoot.this.changFootViewByScolltoFoot(true);
            PublicListViewNoFoot.this.addMoreRefreshListener.onAddMoreRefresh();
        }
    }
    ...
    public PublicListViewNoFoot(Context context) {
        super(context);
        this.PULL_BOTTOM_TO_TOP = 5;
        init(context);
    }

    public PublicListViewNoFoot(Context context, AttributeSet attrs) {
        super(context, attrs);
        this.PULL_BOTTOM_TO_TOP = 5;
    ...
    private void init(Context context) {
        ...
        this.footView.setOnClickListener(new C07761());
    }
