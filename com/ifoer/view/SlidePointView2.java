...
public class SlidePointView2 extends View {
    ...
    public SlidePointView2(Context context) {
        super(context);
    ...
    protected void onDraw(Canvas canvas) {
        ...
        canvas.drawBitmap(this.mPointBitmap, (float) this.mWorkCountIndex[MainMenuActivity.mSlidePoint], 0.0f, null);
    }
}
