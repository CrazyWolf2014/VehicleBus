...
public class NotificationAdapter extends BaseAdapter {
    ...
    public NotificationAdapter(ArrayList<SptTroubleTest> list, Context context) {
        this.list = list;
    ...
    public View getView(int arg0, View convertView, ViewGroup arg2) {
        ...
        String troubleDescribeContent = ByteHexHelper.replaceBlank(((SptTroubleTest) this.list.get(arg0)).getTroubleDescribeContent());
        ...
        item.guili.setText(XmlPullParser.NO_NAMESPACE);
        return convertView;
    }
}
