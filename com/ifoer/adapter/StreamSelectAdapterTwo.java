...
public class StreamSelectAdapterTwo extends BaseAdapter {
    ...
    public StreamSelectAdapterTwo(ArrayList<SptStreamSelectIdItem> sptStreamSelectIdItemList, Context context) {
    ...
    public StreamSelectAdapterTwo(ArrayList<SptStreamSelectIdItem> sptStreamSelectIdItemList, Context context, boolean orientationPortrait, boolean isInitMapData) {
        this.orientationPortrait = false;
        this.item = null;
        this.inflater = LayoutInflater.from(context);
        this.mSptStreamSelectIdItemList = sptStreamSelectIdItemList;
    ...
    public View getView(int arg0, View convertView, ViewGroup arg2) {
        if (convertView == null || convertView.getTag() == null) {
            ...
            RelativeLayout streamItmeSelectGridView = (RelativeLayout) convertView.findViewById(C0136R.id.stream_itme_select_grid_view);
