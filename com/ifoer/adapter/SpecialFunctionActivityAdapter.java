...
public class SpecialFunctionActivityAdapter extends BaseDiagAdapter implements IBaseDiagAdapterInterface {
    private Bitmap bm;
    ...
    public SpecialFunctionActivityAdapter(Context context, List<HashMap<String, Object>> listImage, String language) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (this.language.equals("zh")) {
            ...
            try {
                ...
                baseItem.itemImage.setVisibility(8);
                baseItem.carNameText.setText(this.context.getResources().getText(nameValue).toString().toUpperCase());
                baseItem.carNameText.setText(new StringBuilder(String.valueOf(baseItem.carNameText.getText().toString().substring(0, 5))).append(SpecilApiUtil.LINE_SEP).append(baseItem.carNameText.getText().toString().substring(5)).toString());
