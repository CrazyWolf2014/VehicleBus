...
public class CombinationActivity extends Activity implements OnClickListener {
    private static final boolean f1236D = true;
    ...
    /* renamed from: com.ifoer.expedition.BluetoothChat.CombinationActivity.1 */
    class C03681 implements Runnable {
        C03681() {
        }

        public void run() {
            NetPOSPrinter bmpPrinter = new NetPOSPrinter(CombinationActivity.this.getApplicationContext());
            CombinationActivity.this.bit_first = bmpPrinter.drawBitFirst();
            CombinationActivity.this.bit_second = bmpPrinter.drawBitSecond(CombinationActivity.this.sb.toString());
            CombinationActivity.this.printBitmap = NetPOSPrinter.mixtureBitmap(CombinationActivity.this.bit_first, CombinationActivity.this.bit_second);
            CombinationActivity.this.printResult = bmpPrinter.printPic(CombinationActivity.this.printBitmap);
            bmpPrinter.resultToast(CombinationActivity.this.printResult);
            CombinationActivity.this.baseHandler.obtainMessage(0, Integer.valueOf(CombinationActivity.this.printResult)).sendToTarget();
        }
    }

    /* renamed from: com.ifoer.expedition.BluetoothChat.CombinationActivity.2 */
    class C03692 extends Handler {
        C03692() {
        }
        ...
        public void handleMessage(Message msg) {
            switch (msg.what) {
                case InBandBytestreamManager.MAXIMUM_BLOCK_SIZE /*65535*/:
                    CombinationActivity.this.dayin();
                case 10101010:
                    if (CombinationActivity.this.progressDialog != null && CombinationActivity.this.progressDialog.isShowing()) {
                        SimpleDialog.closeProgressDialog(CombinationActivity.this.progressDialog);
                    }
                    SimpleDialog.checkConectior(CombinationActivity.this.contexts, CombinationActivity.this.getString(C0136R.string.initializeTilte), CombinationActivity.this.getString(C0136R.string.check_connector));
                default:
            }
        }
    }

    /* renamed from: com.ifoer.expedition.BluetoothChat.CombinationActivity.3 */
    class C03703 implements OnItemClickListener {
        C03703() {
        }

        public void onItemClick(AdapterView<?> adapterView, View arg1, int arg2, long arg3) {
            CToJava.combinationFlag = Boolean.valueOf(CombinationActivity.f1236D);
    ...
    class InitData extends AsyncTask<Integer, Integer, String> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            CombinationActivity.this.progressDialogs = new ProgressDialog(this.context);
            CombinationActivity.this.progressDialogs.setMessage(CombinationActivity.this.getResources().getString(C0136R.string.find_wait));
            CombinationActivity.this.progressDialogs.setCancelable(false);
            CombinationActivity.this.progressDialogs.show();
        }
        ...
        protected void onPostExecute(String result) {
            if (CombinationActivity.this.adapter == null) {
                CombinationActivity.this.adapter = new CarCombinationAdapter(CombinationActivity.this.dataList, CombinationActivity.this);
                CombinationActivity.this.listView.setAdapter(CombinationActivity.this.adapter);
                CombinationActivity.this.listView.setSelection(CombinationActivity.this.firstNum);
            } else {
                CombinationActivity.this.adapter.notifyDataSetChanged();
            }
            if (CombinationActivity.this.progressDialogs != null && CombinationActivity.this.progressDialogs.isShowing()) {
                CombinationActivity.this.progressDialogs.dismiss();
            }
        }
    }
    ...
    private class mBroadcastReceiver extends BroadcastReceiver {
        ...
        public void onReceive(Context context, Intent intent) {
            if (CombinationActivity.this.isExecuteS) {
                if (intent.getAction().equals("android.intent.action.SCREEN_ON")) {
                    if ((System.currentTimeMillis() - CombinationActivity.this.lastTime) / 1000 > 30) {
                        SimpleDialog.ExitDialog(context);
                    }
                }
                if (intent.getAction().equals("android.intent.action.SCREEN_OFF")) {
                    CombinationActivity.this.lastTime = System.currentTimeMillis();
                }
                if (intent.getAction().equals("android.bluetooth.device.action.ACL_DISCONNECTED")) {
                    ...
                    Intent active = new Intent(CombinationActivity.this, ActiveTestActivity.class);
                    active.putExtra("ACTIVE_TEST", sptActiveTest);
                    active.setFlags(AccessibilityEventCompat.TYPE_VIEW_ACCESSIBILITY_FOCUS_CLEARED);
                    CombinationActivity.this.startActivity(active);
                    SimpleDialog.closeProgressDialog(CombinationActivity.this.progressDialog);
                    CombinationActivity.this.overridePendingTransition(0, 0);
                    CombinationActivity.this.finish();
                    CombinationActivity.this.overridePendingTransition(0, 0);
                } else if (intent.getAction().equals("SPT_NOBUTTONBOX_TEXT")) {
                    if (CombinationActivity.this.progressDialog == null) {
                        CombinationActivity.this.progressDialog = new ProgressDialog(CombinationActivity.this.contexts);
                        CombinationActivity.this.progressDialog.setCancelable(false);
                    } else {
                        CombinationActivity.this.progressDialog.dismiss();
                        CombinationActivity.this.progressDialog = null;
                        CombinationActivity.this.progressDialog = new ProgressDialog(CombinationActivity.this.contexts);
                        CombinationActivity.this.progressDialog.setCancelable(false);
                    }
                    Spt_Nobuttonbox_Text nobuttonbox = (Spt_Nobuttonbox_Text) intent.getExtras().getSerializable("Nobuttonbox");
                    SimpleDialog.openProgressDialog(CombinationActivity.this.contexts, nobuttonbox.getTitle(), nobuttonbox.getContent(), CombinationActivity.this.progressDialog);
                    ...
                    r0 = new Intent(CombinationActivity.this, StreamSelectActivityTwo.class);
                    ...
                    r0 = new Intent(CombinationActivity.this, DataStreamActivity.class);
                    ...
                    SimpleDialogControl.showDiaglog(CombinationActivity.this.contexts, dialogType, sptMessageBoxText);
                } else if (intent.getAction().equals("ConnectionLost")) {
                    Toast.makeText(CombinationActivity.this.getApplicationContext(), "Device connection was lost", 0).show();
                    ...
                    SimpleDialog.sptInputStringExDiagnose(CombinationActivity.this.contexts, inputString.getDialogTitle(), inputString.getDialogContent(), inputString.getInputHint());
                    ...
                    SimpleDialog.sptInputNumericDiagnose(CombinationActivity.this.contexts, inputNumric.getDialogTitle(), inputNumric.getDialogContent(), inputNumric.getInputHint(), inputNumric.getDigit());
                    ...
                    SimpleDialog.sptInputBoxTextDiagnose(CombinationActivity.this.contexts, inputBox.getTitle(), inputBox.getContent());
                    ...
                    SimpleDialog.sptInputStringDiagnose(CombinationActivity.this.contexts, inputStr.getTitle(), inputStr.getContent());
                    ...
                    r0 = new Intent(CombinationActivity.this, FaultCodeFrozenActivity.class);
                    ...
                    r0 = new Intent(CombinationActivity.this, VWDataStreamActivity.class);
                    ...
                    SimpleDialog.sptShowPictureDiagnose(CombinationActivity.this.contexts, pictureName);
                    ...
                    if (spt.getData() == null || spt.getData().size() <= 0) {
                        CombinationActivity.this.dataList.addAll(spt.getData());
                        CombinationActivity.this.firstNum = spt.getFirstNum();
                        CombinationActivity.this.dataList.remove(0);
                        Integer[] numArr = new Integer[0];
                        new InitData(CombinationActivity.this).execute(r0);
                        SimpleDialog.closeProgressDialog(CombinationActivity.this.progressDialog);
                        return;
                    }
                    menu = new Intent(CombinationActivity.this, CombinationTwoActivity.class);
                    menu.putExtra("SPT_COMBINATION_MENU", spt);
                    menu.setFlags(AccessibilityEventCompat.TYPE_VIEW_ACCESSIBILITY_FOCUS_CLEARED);
                    SimpleDialog.closeProgressDialog(CombinationActivity.this.progressDialog);
                    CombinationActivity.this.startActivity(menu);
                    CombinationActivity.this.overridePendingTransition(0, 0);
    ...
    private void initialize() {
        ...
        this.listView.setOnItemClickListener(new C03703());
    }
    ...
    public boolean onKeyDown(int keyCode, KeyEvent event) {
        ...
        CToJava.combinationFlag = Boolean.valueOf(f1236D);
        return f1236D;
    }
