...
public class MyRadioGroup extends LinearLayout {
    ...
    private class PassThroughHierarchyChangeListener implements OnHierarchyChangeListener {
        ...
        public void onChildViewAdded(View parent, View child) {
            if (parent == MyRadioGroup.this && (child instanceof RadioButton)) {
                ...
                ((RadioButton) child).setOnCheckedChangeListener(MyRadioGroup.this.mChildOnCheckedChangeListener);
            } else if (parent == MyRadioGroup.this && (child instanceof ViewGroup)) {
                RadioButton btn = MyRadioGroup.this.findRadioButton((ViewGroup) child);
                if (btn.getId() == -1) {
                    btn.setId(btn.hashCode());
                }
                btn.setOnCheckedChangeListener(MyRadioGroup.this.mChildOnCheckedChangeListener);
            }
        ...
        public void onChildViewRemoved(View parent, View child) {
            if (parent == MyRadioGroup.this && (child instanceof RadioButton)) {
                ...
                MyRadioGroup.this.findRadioButton((ViewGroup) child).setOnCheckedChangeListener(null);
            }
            if (this.mOnHierarchyChangeListener != null) {
    ...
    public void addView(View child, int index, android.view.ViewGroup.LayoutParams params) {
        ...
        if (child instanceof RadioButton) {
            ...
            button = findRadioButton((ViewGroup) child);
            if (button.isChecked()) {
                this.mProtectFromCheckedChange = true;
                if (this.mCheckedId != -1) {
                    setCheckedStateForView(this.mCheckedId, false);
