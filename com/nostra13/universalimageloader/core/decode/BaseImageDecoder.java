...
public class BaseImageDecoder implements ImageDecoder {
    ...
    public Bitmap decode(ImageDecodingInfo decodingInfo) throws IOException {
        ...
        C0797L.m1475e(ERROR_CANT_DECODE_IMAGE, decodingInfo.getImageKey());
    ...
    L_0x002d:
        ...
        r7 = 0;
        r6[r7] = r9;
        com.nostra13.universalimageloader.utils.C0797L.m1479w(r5, r6);
        goto L_0x0018;
        */
    ...
    protected Options prepareDecodingOptions(ImageSize imageSize, ImageDecodingInfo decodingInfo) {
        ...
        if (scaleType != ImageScaleType.NONE) {
            ...
            if (this.loggingEnabled) {
                C0797L.m1474d(LOG_SABSAMPLE_IMAGE, imageSize, imageSize.scaleDown(scale), Integer.valueOf(scale), decodingInfo.getImageKey());
            }
        }
    ...
    protected Bitmap considerExactScaleAndOrientaiton(Bitmap subsampledBitmap, ImageDecodingInfo decodingInfo, int rotation, boolean flipHorizontal) {
        ...
        if (scaleType == ImageScaleType.EXACTLY || scaleType == ImageScaleType.EXACTLY_STRETCHED) {
            ...
            if (Float.compare(scale, 1.0f) != 0) {
                ...
                if (this.loggingEnabled) {
                    C0797L.m1474d(LOG_SCALE_IMAGE, srcSize, srcSize.scale(scale), Float.valueOf(scale), decodingInfo.getImageKey());
                }
            }
        }
        if (flipHorizontal) {
            ...
            if (this.loggingEnabled) {
                C0797L.m1474d(LOG_FLIP_IMAGE, decodingInfo.getImageKey());
            }
        }
        if (rotation != 0) {
            m.postRotate((float) rotation);
            if (this.loggingEnabled) {
                C0797L.m1474d(LOG_ROTATE_IMAGE, Integer.valueOf(rotation), decodingInfo.getImageKey());
            }
        }
