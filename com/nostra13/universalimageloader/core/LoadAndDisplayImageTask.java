...
final class LoadAndDisplayImageTask implements Runnable {
    ...
    class C07871 implements Runnable {
        ...
        C07871(FailType failType, Throwable th) {
            ...
            try {
                if (!checkTaskIsNotActual()) {
                    ...
                    if (bmp == null) {
                        ...
                        if (this.imageAwareCollected) {
                            ...
                            if (this.options.shouldPreProcess()) {
                                ...
                                if (bmp == null) {
                                    C0797L.m1475e(ERROR_PRE_PROCESSOR_NULL, new Object[0]);
                                }
                            }
                    ...
                    if (bmp != null && this.options.shouldPostProcess()) {
                        ...
                        if (bmp == null) {
                            C0797L.m1475e(ERROR_PRE_PROCESSOR_NULL, this.memoryCacheKey);
                        }
                    }
                    loadFromUriLock.unlock();
        ...
        synchronized (pause) {
            if (pause.get()) {
                ...
                try {
                    ...
                    C0797L.m1475e(LOG_TASK_INTERRUPTED, this.memoryCacheKey);
                    return true;
                }
            }
        }
    ...
    private boolean downloadSizedImage(File targetFile, int maxWidth, int maxHeight) throws IOException {
        ...
        if (bmp != null) {
            if (this.configuration.processorForDiscCache != null) {
                ...
                if (bmp == null) {
                    C0797L.m1475e(ERROR_PROCESSOR_FOR_DISC_CACHE_NULL, this.memoryCacheKey);
                }
            }
    ...
    private void fireFailEvent(FailType failType, Throwable failCause) {
        if (!Thread.interrupted()) {
            if (this.options.isSyncLoading()) {
                ...
                this.handler.post(new C07871(failType, failCause));
            }
        }
    }
    ...
    private void log(String message) {
        if (this.writeLogs) {
            C0797L.m1474d(message, this.memoryCacheKey);
        }
    }

    private void log(String message, Object... args) {
        if (this.writeLogs) {
            C0797L.m1474d(message, args);
        }
    }
}
