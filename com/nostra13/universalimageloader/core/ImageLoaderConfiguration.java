    ...
    public static class Builder {
        ...
        public Builder taskExecutor(Executor executor) {
            if (!(this.threadPoolSize == DEFAULT_THREAD_POOL_SIZE && this.threadPriority == DEFAULT_THREAD_PRIORITY && this.tasksProcessingType == DEFAULT_TASK_PROCESSING_TYPE)) {
                C0797L.m1479w(WARNING_OVERLAP_EXECUTOR, new Object[0]);
            }
        ...
        public Builder memoryCacheSize(int memoryCacheSize) {
            ...
            if (this.memoryCache != null) {
                C0797L.m1479w(WARNING_OVERLAP_MEMORY_CACHE, new Object[0]);
            }
        ...
        public Builder discCacheSize(int maxCacheSize) {
            ...
            if (this.discCache != null || this.discCacheFileCount > 0) {
                C0797L.m1479w(WARNING_OVERLAP_DISC_CACHE_PARAMS, new Object[0]);
            }
        ...
        public Builder discCacheFileNameGenerator(FileNameGenerator fileNameGenerator) {
            if (this.discCache != null) {
                C0797L.m1479w(WARNING_OVERLAP_DISC_CACHE_NAME_GENERATOR, new Object[0]);
            }
