...
public class FeedbackModel extends BaseModel {
    ...
    public String toString() {
        return "FeedbackModel [serial_no=" + this.serial_no + ", auto_code=" + this.auto_code + ", updated=" + this.updated + ", user_id=" + this.user_id + ", review_level=" + this.review_level + ", user_name=" + this.user_name + ", nick_name=" + this.nick_name + ", thumb_url=" + this.thumb_url + "]";
    }
}
