...
public class AsyncHttpClient {
    ...
    /* renamed from: com.cnlaunch.framework.network.http.AsyncHttpClient.1 */
    class C01121 implements HttpRequestInterceptor {
        C01121() {
        }
    ...
    /* renamed from: com.cnlaunch.framework.network.http.AsyncHttpClient.2 */
    class C01132 implements HttpResponseInterceptor {
        C01132() {
        }
    ...
    /* renamed from: com.cnlaunch.framework.network.http.AsyncHttpClient.3 */
    class C01143 extends DefaultRedirectHandler {
    ...
    public AsyncHttpClient(SchemeRegistry schemeRegistry) {
        ...
        this.httpClient.addRequestInterceptor(new C01121());
        this.httpClient.addResponseInterceptor(new C01132());
    ...
    public void setEnableRedirects(boolean enableRedirects) {
        this.httpClient.setRedirectHandler(new C01143(enableRedirects));
    }
    ...
    public static String getUrlWithQueryString(boolean shouldEncodeUrl, String url, RequestParams params) {
        ...
        if (params != null) {
            ...
            if (url.contains("?")) {
                url = new StringBuilder(String.valueOf(url)).append(AlixDefine.split).append(paramString).toString();
            } else {
                url = new StringBuilder(String.valueOf(url)).append("?").append(paramString).toString();
            }
        }
        NLog.m916d(LOG_TAG, "url: " + url);
        return url;
    }
