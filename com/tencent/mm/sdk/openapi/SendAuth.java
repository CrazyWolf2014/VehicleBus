...
public final class SendAuth {
    ...
    public static class Req extends BaseReq {
        ...
        final boolean checkArgs() {
            if (this.scope == null || this.scope.length() == 0 || this.scope.length() > Flags.FLAG5) {
                Log.m1657e("MicroMsg.SDK.SendAuth.Req", "checkArgs fail, scope is invalid");
                return false;
            } else if (this.state == null || this.state.length() <= Flags.FLAG5) {
                return true;
            } else {
                Log.m1657e("MicroMsg.SDK.SendAuth.Req", "checkArgs fail, state is invalid");
                return false;
            }
        }
    ...
    public static class Resp extends BaseResp {
        ...
        final boolean checkArgs() {
            if (this.state == null || this.state.length() <= Flags.FLAG5) {
                return true;
            }
            Log.m1657e("MicroMsg.SDK.SendAuth.Resp", "checkArgs fail, state is invalid");
            return false;
        }
