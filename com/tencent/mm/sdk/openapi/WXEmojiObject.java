...
public class WXEmojiObject implements IMediaObject {
    ...
    public boolean checkArgs() {
        if ((this.emojiData == null || this.emojiData.length == 0) && (this.emojiPath == null || this.emojiPath.length() == 0)) {
            Log.m1657e("MicroMsg.SDK.WXEmojiObject", "checkArgs fail, both arguments is null");
            return false;
            ...
            if (this.emojiPath != null) {
                ...
                if (i > 10485760) {
                    Log.m1657e("MicroMsg.SDK.WXEmojiObject", "checkArgs fail, emojiSize is too large");
                    return false;
                }
            }
            return true;
        } else {
            Log.m1657e("MicroMsg.SDK.WXEmojiObject", "checkArgs fail, emojiData is too large");
            return false;
        }
    }
