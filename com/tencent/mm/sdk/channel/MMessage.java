...
public class MMessage {
    ...
    public static final class Receiver extends BroadcastReceiver {
        ...
        public final void onReceive(Context context, Intent intent) {
            Log.m1655d("MicroMsg.SDK.MMessage", "receive intent=" + intent);
            if (this.f1624o != null) {
                this.f1624o.handleMessage(intent);
                Log.m1655d("MicroMsg.SDK.MMessage", "mm message self-handled");
                return;
            }
            CallBack callBack = (CallBack) callbacks.get(intent.getAction());
            if (callBack != null) {
                callBack.handleMessage(intent);
                Log.m1655d("MicroMsg.SDK.MMessage", "mm message handled");
            }
        }
    }
    ...
    public static boolean send(Context context, String str, String str2, String str3, Bundle bundle) {
        ...
        intent.putExtra(ConstantsMMessage.CHECK_SUM, MMessageUtil.m1643a(str3, packageName));
        context.sendBroadcast(intent, str4);
        Log.m1655d("MicroMsg.SDK.MMessage", "send mm message, intent=" + intent + ", perm=" + str4);
        return true;
    }
}
