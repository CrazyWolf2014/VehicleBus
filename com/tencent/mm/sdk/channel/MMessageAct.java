...
public class MMessageAct {
    ...
    public static boolean send(Context context, String str, String str2, String str3, Bundle bundle) {
        if (context == null || str == null || str.length() == 0 || str2 == null || str2.length() == 0) {
            Log.m1657e("MicroMsg.SDK.MMessageAct", "send fail, invalid arguments");
            return false;
        }
        ...
        try {
            ...
            Log.m1655d("MicroMsg.SDK.MMessageAct", "send mm message, intent=" + intent);
            return true;
        } catch (ActivityNotFoundException e) {
            Log.m1657e("MicroMsg.SDK.MMessageAct", "send fail, target ActivityNotFound");
            return false;
        }
    }
