...
public class MMPluginProviderConstants {
    ...
    public static final class Resolver {
        ...
        public static int getType(Object obj) {
            if (obj == null) {
                Log.m1657e("MicroMsg.SDK.PluginProvider.Resolver", "unresolve failed, null value");
                return 0;
                ...
                Log.m1657e("MicroMsg.SDK.PluginProvider.Resolver", "unresolve failed, unknown type=" + obj.getClass().toString());
                return 0;
            }
        }
        ...
        public static Object resolveObj(int i, String str) {
            switch (i) {
                ...
                default:
                    try {
                        Log.m1657e("MicroMsg.SDK.PluginProvider.Resolver", "unknown type");
                    } catch (Exception e) {
                        e.printStackTrace();
                    }
                    return null;
        ...
        public static boolean unresolveObj(ContentValues contentValues, Object obj) {
            ...
            contentValues.put(SharedPref.TYPE, Integer.valueOf(type));
