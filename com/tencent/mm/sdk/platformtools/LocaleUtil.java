...
public final class LocaleUtil {
    ...
    private static String m1654d(String str) {
    ...
    public static String getApplicationLanguage() {
        ...
        return (nullAsNil.length() <= 0 || nullAsNil.equals(LANGUAGE_DEFAULT)) ? m1654d(ENGLISH) : nullAsNil;
    }
    ...
    public static void saveApplicationLanguage(SharedPreferences sharedPreferences, Context context, String str) {
        if (sharedPreferences.edit().putString(LANGUAGE_KEY, str).commit()) {
            ...
            Log.m1665w("MicroMsg.LocaleUtil", "save application lang as:" + str);
            return;
        }
        Log.m1657e("MicroMsg.LocaleUtil", "saving application lang failed");
    }
    ...
    public static Locale transLanguageToLocale(String str) {
        ...
        Log.m1657e("MicroMsg.LocaleUtil", "transLanguageToLocale country = " + str);
        return Locale.ENGLISH;
    }
