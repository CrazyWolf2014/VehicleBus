...
public abstract class MAutoDBItem extends IAutoDBItem {
    public void convertFrom(Cursor cursor) {
        ...
        if (columnNames == null) {
            Log.m1657e("MicroMsg.SDK.MAutoDBItem", "convertFrom: get column names failed");
            return;
        }
        int i2;
        ...
        i2 = Util.nullAs((Integer) hashMap.get(IAutoDBItem.SYSTEM_ROWID_FIELD), -1);
        if (i2 >= 0) {
    ...
    public ContentValues convertTo() {
        ...
        if (this.systemRowid > 0) {
            contentValues.put(IAutoDBItem.SYSTEM_ROWID_FIELD, Long.valueOf(this.systemRowid));
        }
