...
public class ParseException extends Exception {
    ...
    public ParseException(String str, Throwable th) {
        super(new StringBuffer().append(str).append(MinimalPrettyPrinter.DEFAULT_ROOT_VALUE_SEPARATOR).append(th).toString());
        this.lineNumber_ = -1;
        this.cause_ = null;
        this.cause_ = th;
    }
    ...
    static String charRepr(int i) {
        return i == -1 ? "EOF" : new StringBuffer().append(XmlPullParser.NO_NAMESPACE).append((char) i).toString();
    }
