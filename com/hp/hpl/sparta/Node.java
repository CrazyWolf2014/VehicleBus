...
public abstract class Node {
    ...
    class C10631 implements BooleanExprVisitor {
        ...
        C10631(Node node, Element element, Element element2, String str, String str2) throws XPathException {
            this.this$0 = node;
        ...
        public void visit(AttrGreaterExpr attrGreaterExpr) throws XPathException {
            this.val$newChild.setAttribute(attrGreaterExpr.getAttrName(), Long.toString(MAlarmHandler.NEXT_FIRE_INTERVAL));
        }
    ...
    Element makeMatching(Element element, Step step, String str) throws ParseException, XPathException {
        ...
        if (nodeTest instanceof ElementTest) {
            ...
            step.getPredicate().accept(new C10631(this, element2, element, str, tagName));
            return element2;
        }
