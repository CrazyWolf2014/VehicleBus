...
public class TableStatements {
    ...
    public String getSelectAll() {
        if (this.selectAll == null) {
            this.selectAll = SqlUtils.createSqlSelect(this.tablename, NDEFRecord.TEXT_WELL_KNOWN_TYPE, this.allColumns);
        }
    ...
    public String getSelectByKey() {
        if (this.selectByKey == null) {
            ...
            SqlUtils.appendColumnsEqValue(builder, NDEFRecord.TEXT_WELL_KNOWN_TYPE, this.pkColumns);
