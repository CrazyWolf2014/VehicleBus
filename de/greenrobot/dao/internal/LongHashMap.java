...
public final class LongHashMap<T> {
    ...
    public void logStats() {
        ...
        DaoLog.m1701d("load: " + (((float) this.size) / ((float) this.capacity)) + ", size: " + this.size + ", capa: " + this.capacity + ", collisions: " + collisions + ", collision ratio: " + (((float) collisions) / ((float) this.size)));
    }
}
